...
(deftest limit
  (testing "Limit number of total elements in split queue."
...
(deftest ordered-queue
  (testing "Items are taken from single queue in first in first out order."
    (let [sq0 (split-queue/make 3 Long/MIN_VALUE)
...
(deftest round-robin-queues
  (testing "Queues should be chosen from in a round robin fashion."
    (let [sq0 (split-queue/make 3 Long/MIN_VALUE)
          [_ sq1] (split-queue/put sq0 0 "a")
          [_ sq2] (split-queue/put sq1 0 "b")
